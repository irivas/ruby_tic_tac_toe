...
describe ConsoleUI::GameOptionsUI do
  describe "#request_game_type" do
    it "outputs possible game types and returns GameType matching user selection" do
      ...
      expect(ui.request_game_type).to eq(ConsoleUI::HUMAN_HUMAN)
